...
export const translations: Record<Lang, Record<string, string>> = {
  es: {
    ...
    'home.module-label': 'Módulo',
    'home.challenge-label': 'Reto del día ·',
    'home.xp-badge': '+50 XP',
    'home.start': 'Iniciar →',
    'home.all-done-title': '¡Completaste todas las lecciones! 🎉',
    'home.all-done-desc': 'Repasa el glosario o pon a prueba lo aprendido en el Code Lab.',
...
'player.show': 'Mostrar reproductor',
  ...
  en: {
    ...
    'home.module-label': 'Module',
    'home.challenge-label': 'Daily challenge ·',
    'home.xp-badge': '+50 XP',
    'home.start': 'Start →',
    'home.all-done-title': 'You completed every lesson! 🎉',
    'home.all-done-desc': 'Review the glossary or put your knowledge to the test in the Code Lab.',
